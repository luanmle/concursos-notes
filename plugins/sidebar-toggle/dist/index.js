// plugins/sidebar-toggle/src/components/sidebartoggle.inline.ts
var sidebartoggle_inline_default = '(()=>{function o(){let e=document.getElementById("sidebar-toggle-btn");if(!e)return;let t=()=>{let n=document.documentElement.classList.toggle("sidebar-collapsed");try{localStorage.setItem("sidebar-collapsed",String(n))}catch{}};e.addEventListener("click",t),window.addCleanup(()=>e.removeEventListener("click",t))}document.addEventListener("nav",o);})();\n';

// plugins/sidebar-toggle/src/components/sidebartoggle.scss
var sidebartoggle_default = "button.sidebar-toggle {\n  align-self: flex-start;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 0.3rem;\n  border: none;\n  border-radius: 6px;\n  background: transparent;\n  color: var(--gray);\n  cursor: pointer;\n}\nbutton.sidebar-toggle:hover {\n  color: var(--secondary);\n  background: var(--highlight);\n}\n\nhtml.sidebar-collapsed .sidebar.left > *:not(.sidebar-toggle) {\n  display: none !important;\n}\n\n@media all and (min-width: 1200px) {\n  html.sidebar-collapsed .page > #quartz-body {\n    grid-template-columns: 3.5rem auto 320px;\n  }\n}\n@media all and (min-width: 800px) and (max-width: 1200px) {\n  html.sidebar-collapsed .page > #quartz-body {\n    grid-template-columns: 3.5rem auto;\n  }\n}\n@media all and (min-width: 800px) {\n  html.sidebar-collapsed .sidebar.left {\n    padding-left: 0.75rem;\n    padding-right: 0.75rem;\n    align-items: center;\n  }\n}\n@media all and (max-width: 800px) {\n  button.sidebar-toggle {\n    display: none;\n  }\n}";
...
// plugins/sidebar-toggle/src/components/SidebarToggle.tsx
var SidebarToggleConstructor = () => {
  const SidebarToggle = ({ displayClass }) => {
    return /* @__PURE__ */ u2(
      "button",
      {
  ...
  SidebarToggle.css = sidebartoggle_default;
  ...
  `;
  SidebarToggle.afterDOMLoaded = sidebartoggle_inline_default;
  return SidebarToggle;
};
var SidebarToggle_default = SidebarToggleConstructor;
export {
  SidebarToggle_default as SidebarToggle
};
